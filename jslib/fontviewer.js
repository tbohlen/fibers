/* This file was generated from TypeScript source tslib/fontviewer.ts */
...
// FontViewer
//
var FontViewer = (function () {
    function FontViewer() { }
    FontViewer.version = 1;
    FontViewer.create = // Constructor function
    function create(tz, applicationSettings) {
        ...
        vi.semantics = gd.createSemantics([
            'POSITION', 
            'TEXCOORD0'
        ]);
        ...
        vi.debugVertexFormats = [
            gd.VERTEXFORMAT_FLOAT2
        ];
        vi.debugSemantics = gd.createSemantics([
            'POSITION'
        ]);
        ...
        vi.load = function viewerLoadFn(assetPath) {
            ...
            tz.request(vi.pathPrefix + 'shaders/gui.cgfx', function (shaderText) {
